!function a(b, c, e) {
    ...
    1: [function (b, a, c) {
            ...
            e = function (a, c) {
                ...
                if (b && typeof b === 'string') {
                    ...
                    if (a.nodeType === 1) if (!a.className) a.className = b; else {
                        var f = ' ' + a.className + ' ', e = a.className;
                ...
                while (a) {
                    var d = parseInt(e(a, 'borderLeftWidth'), 10), f = parseInt(e(a, 'borderTopWidth'), 10);
                ...
                var c = b.prototype._singleton, a = document.getElementById('global-zeroclipboard-html-bridge');
                if (!a) {
                ...
                switch (b) {
                    case'load':
                        if (d && parseFloat(d.flashVersion.replace(',', '.').replace(/[^0-9\.]/gi, '')) < 10) {
                            this.receiveEvent('onWrongFlash', {flashVersion: d.flashVersion});
                            return
                        }
                    ...
                    case'mouseup':
                        ...
                        break;
                    case'datarequested':
                        var h = a.getAttribute('data-clipboard-target'), e = h ? document.getElementById(h) : null;
                        if (e) {
        ...
        var c = typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {},
            ...
            g = {path: '../js/ZeroClipboard.swf', copy: null, beforeCopy: null, afterCopy: null, clickAfter: !0},
            f = function (a) {
                return a = 0, function () {
                    return a++
                }
        ...
        a.fn.zclip = function (i) {
            ...
            if (a.isPlainObject(i)) h = a.extend({}, g, i), j = f(), d[j] = h, this.data('zclip-client', j), b ? b.glue(this) : b = new e(this, {
                ...
                var b = g.text, e = a(this), f = d[e.data('zclip-client')];
                ...
                var b = a(this), c = d[b.data('zclip-client')];
