...
var DEFAULT_URL = '../../pdf/NextDocumen1t.pdf';
...
var PDFPageView = function () {
  ...
  _createClass(PDFPageView, [{
    ...
    value: function reset() {
      ...
      var div = this.div;
     div.style.width = Math.floor(this.viewport.width) +40+ 'px';
      div.style.height = Math.floor(this.viewport.height)+ 40 + 'px';
    ...
    value: function paintOnCanvas(canvasWrapper) {
      ...
      canvas.style.width = (0, _ui_utils.roundToDivide)(viewport.width, sfx[1]) + 40+'px';
      canvas.style.height = (0, _ui_utils.roundToDivide)(viewport.height, sfy[1]) + 40+ 'px';
