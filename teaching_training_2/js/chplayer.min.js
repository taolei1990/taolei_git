...
!(function () {
    ...
    chplayer.prototype = {
        config: {videoClick: true, videoDbClick: true, errorTime: 100, videoDrawImage: false},
        varsConfig: {
            container: '',
            variable: 'chplayer',
            volume: 0.8,
        ...
        contextMenu: [
            ['全通云教育', 'link', 'http://www.yunjy.com.cn'],
            ['v2.1.20', 'default'],
            ['播放视频', 'function', 'play', 'line'],
            ['暂停视频', 'function', 'pause'],
            ['播放/暂停', 'function', 'playOrPause'],
            ['技术支持', 'javascript', 'qtySupport', 'line']
        ],
        errorList: [
        ...
        interFace: function () {
            ...
            var controlBarBg = document.createElement('div'), controlBar = document.createElement('div'),
                ...
                loading = document.createElement('div'), logo = document.createElement('div');
        ...
        promptShow: function (ele, data) {
            ...
            if (ele || data) {
                if (!this.isUndefined(data)) {
                    ...
                    obj = {title: ele.dataset.title, x: offsetCoor['x'] + ele.offsetWidth * 0.5, y: offsetCoor['y']}
                }
        ...
        embedSWF: function () {
            ...
            var html = '', src = javascriptPath + 'chplayer.swf';
            id = 'id="' + vid + '" name="' + vid + '" ';
